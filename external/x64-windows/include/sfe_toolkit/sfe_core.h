...
/// @param out_hwid Pointer to a buffer where the HWID will be stored.
/// Providing a null pointer will determine the necessary buffer size.
/// @param in_out_hwid_len IN: Total size of the out_hwid buffer. OUT: Actual
/// size of the data written to the out_hwid buffer.
/// @param method A method to use for HWID computation.
...
/// supplied.
/// @param info Pointer to a `SFELicenseSource`.
...
/// @param data_len Length of the license data.
void sfeLicenseSet(const unsigned char *data, const size_t data_len);

/// @brief Create new solver from solver file.
/// @param solver_file Solver file to create the solver from.
/// @param solver_parameters Pointer to collection of solver parameters.
/// @param solver_parameters_count Number of solver parameters.
/// @param out_solver New solver.
...
/// ..
/// @param data Image data to load image from.
/// @param data_len Size of the image data in bytes.
/// @param out_image Raw raster image.
...
/// @param image_format Image format to encode to.
/// @param out_data Image data to save image into.
/// @param in_out_data_len IN: Total size of the out_data buffer. OUT: Actual
...
/// @param data Image data to load image from.
/// @param data_len Size of the image data in bytes.
/// @param out_width Width of the image data.
/// @param out_height Height of the image data.
/// @param oyt_image_format Format of the image data.
/// @return Error in cas of unknown image type.
...
/// @param image Image to color transpose.
/// @return Error
SFEError sfeImageColorTranspose(SFEImageView image);

/// @brief Resize image.
/// @param image Source image view to resize.
/// @param width Target resize width.
/// @param height Target resize height.
/// @param out_image Resized image.
/// @return Error
